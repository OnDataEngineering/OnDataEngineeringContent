...
tech-relationships: [[packages, Accumulo, Atlas, Calcite, DataFu, Druid, Hadoop, HBase, Hive, Kafka, Knox, Livy, Oozie, Phoenix, Pig, Ranger, Spark, Sqoop, Storm, Tez, Zeppelin, ZooKeeper, Superset], [add ons, HDP Search, Hortonworks HDB, Hortonworks Cybersecurity Package, SmartSense], [manageable via, Ambari, Cloudbreak]]
...
* [Apache Superset](/technologies/apache-superset) was added in tech preview in HDP 3.0

## Release History

| version | release date | release links | release comment
| 2.6 | 2017-02-28 | [announcement](https://hortonworks.com/blog/announcing-the-general-availability-of-hortonworks-data-platform-2-6/); [release notes](https://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.6.0/bk_release-notes/content/ch_relnotes.html) | See notes above for tech changes
| 3.0 | 2018-07-13 | [early access announcement](https://hortonworks.com/blog/announcing-hdp-3-0-faster-smarter-hybrid-data/); [GA announcement](https://hortonworks.com/blog/announcing-general-availability-hortonworks-data-platform-3-0-0-ambari-2-7-0-smartsense-1-5-0/); [release notes](https://docs.hortonworks.com/HDPDocuments/HDP3/HDP-3.0.0/release-notes/index.html); [Hive 2x perf](https://hortonworks.com/blog/2x-faster-bi-interactive-queries-with-hdp-3-0/)
| 3.1 | 2018-12-12 | [release notes](https://docs.hortonworks.com/HDPDocuments/HDP3/HDP-3.1.0/release-notes/content/relnotes.html); [New Kafka use cases](https://www.zdnet.com/article/ibm-bets-on-a-multi-cloud-future/) | Kafka 2.0; Kafka Streams; Hive+Druid over Kafka
